<template>
    <div class="wrapper">
        <g-nav :selected.sync="selected"  vertical style="width:200px;margin-top:100px;" @update:selected="onChange">
...
<script>
    ...
    import GNavItem from '../../../src/nav/nav-item.vue'
    import GSubNav from '../../../src/nav/sub-nav.vue'
    export default {
        components:{
